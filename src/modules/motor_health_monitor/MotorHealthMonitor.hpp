...
private:
	...
	void publishShadow(const actuator_motors_s &actuator_motors, const motor_health_status_s &health_status);
	...
	uORB::Publication<ftc_allocation_shadow_s> _allocation_shadow_pub{ORB_ID(ftc_allocation_shadow)};
